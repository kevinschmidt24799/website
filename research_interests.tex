...
How can we break a three-way tie with a fair coin? No deterministic finite procedure exists, but which method minimizes expected flips? I've solved this specific case, but the general problem of simulating one probability distribution from another is harder. Even when deterministic methods exist, is the fastest method always deterministic? (I suspect not.) This connects to encoding digits of fractions in various bases.
